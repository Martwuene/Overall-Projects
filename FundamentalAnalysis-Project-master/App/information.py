...
def fscore_magic(df, df1, df2, year):
    ...
    # rearranging columns
    data = data[['Name', 'Sector', 'Market Cap', 'F-Score', 'Magic Formula Ranking', 'ROA', 
                 'CFO', 'Delta ROA', 'Accrual', 'Delta Leverage', 'Delta Liquidity', 
                 'Equity Offering', 'Delta Gross Margin', 'Delta Turnover']]
